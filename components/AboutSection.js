    ...
    <section id="about" className={styles.sectionContainer}>
      <div className={styles.maxWidthWrapper}>
        ...
        <p className={styles.aboutText}>
          بين دقّة اللغة ومنطق البرمجة، اكتشفتُ مساري المهني. باعتباري مُعلِّم لغة عربية، أؤمن أن المعرفة تُبنى على الفهم العميق، وباعتباري مُطوِّر أترجم هذا الفهم إلى تجارب رقمية تنطق بالبساطة والوضوح.
          <br /><br />
