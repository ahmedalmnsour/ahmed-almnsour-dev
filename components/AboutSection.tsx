      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          <p>
            ...
            أبني الواجهات بـ TypeScript مع React وNext.js، وأصوغ تفاصيلها بـ CSS كما يقتضي المقام. 
            <br />ومن الخلف، أبني الخوادم بـ Node.js، وأوظّف Python كلّما ضاقت المسافة بين الفكرة والتنفيذ.<br />
