...
export const articlesData = [
{
...

 {
  ...
  // --- المقال الثالث (Placeholder لتفادي الخطأ) ---
    {
    id: 3,
...

{
    ...
    excerpt: "دراسة تفصيلية حول تقنيات الـ Lazy Loading، تحسين الصور، وتقليل حجم الحزمة (Bundle Size) في التطبيقات الكبيرة.",
  ...
  },
  {
    ...
    excerpt: "كيف قمت ببناء أول Chatbot ذكي لخدمة العملاء، وما هي التحديات التي واجهتها في ضبط الـ Context Window.",
...
content: `
  ...
  },
  {
    ...
    excerpt: "بعد سنوات من كتابة SASS، قررت تجربة Tailwind CSS في مشروع ضخم. إليكم الأسباب التي جعلتني لا أعود للوراء.",
    category: "frontend",
...
content: `
...

  {
    ...
    excerpt: "كيف أنقذتني اختبارات Jest من كارثة في نظام مدفوعات، ولماذا يجب أن يكون الـ Testing جزءاً من ثقافتك.",
    category: "testing",
...
content: `
  ...
  },
  {
    ...
    excerpt: "كيف تنظم مشروعاً يحتوي على 500+ ملف؟ استراتيجيات التقسيم (Features vs Types) للحفاظ على نظافة المشروع.",
  ...
  },
  {
    ...
    excerpt: "عميل كان يملك صحيفة إخبارية بطيئة. فصلنا المحتوى (Backend) عن العرض (Frontend) لنحصل على سرعة تحميل خيالية.",
    category: "architecture",
    categoryLabel: "هندسة البرمجيات 🏗️",
    date: "14 مايو 2021",
    baseViews: 15510,
  ...
  // =================================================================
  {
    ...
    excerpt: "عميل أوروبي كان مهدداً بغرامات ضخمة. رحلة تشفير البيانات وتعديل سياسات الكوكيز للامتثال للقوانين الجديدة.",
    category: "security",
